  ...
  <div>
    <div class="flex border-b p-2 bg-gray-200" @click="searchResultsShow = false">
      ...
      <div class="flex-grow form-wrapper">
        ...
        <input type="text" name="word" v-model="form.word" @input="updateField()" :placeholder="__('Who/what?')" class="w-48 sm:w-64 lg:h-12 h-10 border border-gray-400 py-1 px-2 rounded text-lg focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100 float-left" autocomplete="off" maxlength="32"/>
        <button name="type" value="0" class="bg-heart-color lg:h-12 h-10 py-1 px-4 ml-2 text-white text-lg rounded hover:bg-red-500 focus:outline-none">
        ...
        <button name="type" value="1" class="bg-gray-800 lg:h-12 h-10 py-1 px-4 ml-2 text-white text-lg rounded hover:bg-gray-900 focus:outline-none">
