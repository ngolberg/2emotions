  ...
  <div>
    <div class="flex border-b p-2 bg-gray-200" @click="searchResultsShow = false">
      ...
      <div class="flex-grow form-wrapper">
        ...
        <button name="type" type="submit" value="0" class="bg-heart-color lg:h-12 h-10 py-1 px-4 ml-2 text-white text-lg rounded hover:bg-red-500 focus:outline-none">
        ...
        <button name="type" type="submit" value="1" class="bg-gray-800 lg:h-12 h-10 py-1 px-4 ml-2 text-white text-lg rounded hover:bg-gray-900 focus:outline-none">
