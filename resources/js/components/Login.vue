<template>
  <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
      ...
      <form method="POST" action="/login" class="pt-8" @submit.prevent="submitForm">
        <div class="relative">
          <label for="email" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">E-mail</label>

          <div>
            <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" autocomplete="email" autofocus placeholder="your@email.com">
        ...
        <div class="flex justify-between pt-8 text-white text-sm font-bold">
          <a class="hover:text-blue-200" href="/password/reset">
            Forgot Your Password?
          </a>
          <a class="hover:text-blue-200" href="/register">
            Register
          </a>
        </div>
      </form>
